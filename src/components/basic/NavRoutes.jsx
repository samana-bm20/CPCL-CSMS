        ...
        dropdown: [
            {
                ...
                children: [
                    ...
                    {
                        title: "Hot Work / Confined Space Entry",
                        path: 'requestHotWork'
                    },
                    {
                        title: "Work at Height (Above 2 meters)",
                        path: 'requestHeightWork'
                    },
                    {
                        title: "Radiography",
                        path: 'requestRadiography'
                    },
                    {
                        title: "Vehicle Entry",
                        path: 'requestVehicleEntry'
                    },
                    {
                        title: "Excavation",
                        path: 'requestExcavation'
                    },
                    {
                        title: "Excavation Clearance",
                        path: 'requestExcavationClearance'
                    },
                    {
                        title: "Electrical Isolation",
                        path: 'requestElectricalIsolation'
                    },
                    {
                        title: "Electrical Energisation",
                        path: 'requestElectricalEnergisation'
                    },
                ],
            },
            {
                ...
                children: [
                    ...
                    {
                        title: "Withdraw Permit (User)",
                        path: 'withdrawPermit'
                    },
                    {
                        title: "Excavation Clearance Issue",
                        path: 'issueExcavationClearance'
                    },
                    {
                        title: "Electrical Isolation / Energisation Pending",
                        path: 'issueElectrical'
                    },
                ]
            },
            {
